  ...
  <div class="container my-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
      <div>
        ...
        <div class="text-muted small">Update this open position</div>
      </div>
    </div>
            ...
            <div class="card-body">
              ...
              <div class="mb-3">
                ...
                <textarea
                  ...
                  rows="4"
                  required
                >{{ old('about', $career->about) }}</textarea>
              </div>
              ...
              <div class="mb-3">
                ...
                <textarea
                  ...
                  class="form-control"
                  rows="5"
                >{{ old('requirements', $career->requirements) }}</textarea>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="card-body d-grid gap-3">
              ...
              <div>
                ...
                <select class="form-select" id="status" name="status">
                  <option value="Online" {{ old('status', $career->status ? 'Online' : 'Offline') === 'Online' ? 'selected' : '' }}>Online</option>
                  <option value="Offline" {{ old('status', $career->status ? 'Online' : 'Offline') === 'Offline' ? 'selected' : '' }}>Offline</option>
                </select>
              </div>
            </div>
          </div>
