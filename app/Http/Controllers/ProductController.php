    ...
    public function create()
{
    ...
    public function store(Request $request)
    {
        ...
        $product = Product::create([
            ...
            'estimated_seconds' => isset($validated['estimated_minutes']) ? ((int)$validated['estimated_minutes']) * 60 : null,
    ...
    public function update(Request $request, Product $product)
    {
        ...
        $product->update([
            ...
            'price'         => $validated['price'],
            'goods_price'   => $validated['goods_price'] ?? null,
            'estimated_seconds' => isset($validated['estimated_minutes']) ? ((int)$validated['estimated_minutes']) * 60 : $product->estimated_seconds,
            'product_image' => $imagePath,
            'description'   => $validated['description'] ?? null,
            'featured'      => $validated['featured'],
            'active'        => $validated['active'],
